...
from Purkinje_morpho_1_number_h import number_ind_1

from Synapses_h import Synapse_py3

class Purkinje_Morpho_1_h:
    def __init__(self,spines_on = 0):
        ...
        conductvalues = np.genfromtxt("R_01_final_pop_h.txt")
